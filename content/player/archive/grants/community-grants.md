...
{{< hint warning >}}
**📔 Note**: According to a [Governance Proposal](https://decentraland.org/governance/proposal/?id=1a1433a1-db6f-4126-a0a0-731ed557af24) that passed on November 6, 2024, the deprecation of the current Grants Program and Bidding and Tendering process was approved, aiming to create a more effective, strategically aligned funding model. 
{{< /hint >}}
...
* The topic shouldn’t already be well-covered in the official documentation.
...
* Newly populated land, Active Users, Returning Users, Time on Scene.
* Events created and the number of attendees to the event.
...
Grantees from this category produce content on social media platforms such as Twitch, Twitter, YouTube, TikTok, and Discord. The grant aims to reach new users and keep them engaged.
...
### 7- Sponsorship    
Grantees applying to this category hold conferences, side events, community meetups, hackathons, and contest prizes that target audiences relevant to Decentraland.
