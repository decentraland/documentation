...
In both cases, you assign the video to a `VideoTexture`, which can be used on a [material]({{< ref "/content/creator/deprecated/scenes/3d-essentials/materials.md" >}}) and then applied to any [primitive shape]({{< ref "/content/creator/deprecated/scenes/3d-essentials/shape-components.md" >}}) like a plane, cube, or even a cone.
...
See [materials]({{< ref "/content/creator/deprecated/scenes/3d-essentials/materials.md" >}}) for more details.
