...
- Text: Add a `UIText`component to display text. The properties you can set are the same as in a `TextShape` component. See [text]({{< ref "/content/creator/deprecated/scenes/3d-essentials/text.md" >}}).
...
The `UIText` component lets you add text. It has properties that are similar to the `TextShape` component. See [text]({{< ref "/content/creator/deprecated/scenes/3d-essentials/text.md" >}}).
...
When constructing a `UIImage` component, you must pass a `Texture` component as an argument. Read more about `Texture` components in [materials]({{< ref "/content/creator/deprecated/scenes/3d-essentials/materials.md" >}}).
