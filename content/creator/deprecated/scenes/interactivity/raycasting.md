...
If your scene does raycasting on every frame via a [system]({{< ref "/content/creator/deprecated/scenes/architecture/systems.md" >}}), then you should be careful about how it affects your scene's performance.
