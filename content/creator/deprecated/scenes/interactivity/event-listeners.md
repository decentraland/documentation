...
For button and click events performed by the player, see [Button events]({{< ref "/content/creator/deprecated/scenes/interactivity/click-events.md" >}}).
...
Learn more about playing videos in Decentraland in [Video Playing]({{< ref "/content/creator/deprecated/scenes/media/video-playing.md" >}}).
