...
If you want the texture to be mapped to specific scale or alignment on your entities, then you need to configure _uv_ properties on the [shape components]({{< ref "/content/creator/deprecated/scenes/3d-essentials/shape-components.md" >}}).
...
To stream video from a URL into a material, or play a video from a file stored in the scene, see [video playing]({{< ref "/content/creator/deprecated/scenes/media/video-playing.md" >}}).
