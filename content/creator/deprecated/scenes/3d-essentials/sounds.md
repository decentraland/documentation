...
See [Audio streaming]({{< ref "/content/creator/deprecated/scenes/media/audio-streaming.md" >}}) to learn how you can play a live audio stream from an external source.
