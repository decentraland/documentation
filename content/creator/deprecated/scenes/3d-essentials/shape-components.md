...
Primitive shapes don't include materials. To give it a color or a texture, you must assign a [material component]({{< ref "/content/creator/deprecated/scenes/3d-essentials/materials.md" >}}) to the same entity.
