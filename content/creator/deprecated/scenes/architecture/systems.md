...
Decentraland scenes rely on _systems_ to update the information stored in each entity's [components]({{< ref "/content/creator/deprecated/scenes/architecture/entities-components.md" >}}) as the scene changes.
...
Most of the time, you won't want a system's update function to iterate over the entire set of entities in the scene, as this could be very costly in terms of processing power. To avoid this, you can create a [component group]({{< ref "/content/creator/deprecated/scenes/architecture/component-groups.md" >}}) to keep track of which are the relevant entities, and then have your system iterate over that list.
...
See [entity positioning]({{< ref "/content/creator/deprecated/scenes/3d-essentials/entity-positioning.md" >}}) for examples of how to use `dt` to make movement smoother.
