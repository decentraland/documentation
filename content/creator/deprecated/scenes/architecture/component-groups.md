...
Each component group keeps track of a list of entities that have all the required [components]({{< ref "/content/creator/deprecated/scenes/architecture/entities-components.md" >}}).
