...
Output messages to console (using `console.log()`). You can then view these messages as they are generated by opening the scene console. Toggle the console by pressing the **`** key on your keyboard.
