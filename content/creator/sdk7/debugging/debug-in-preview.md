...
{{< hint warning >}}
**📔 Note**: To use this feature, you must first install the [Creator Hub]({{< ref "/content/creator/sdk7/scene-editor/editor-installation.md" >}}), as the necessary dependencies are bundled with that installation. 
