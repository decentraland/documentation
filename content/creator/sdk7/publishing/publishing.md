...
- **rating**: This is used to classify the content of your scene based on its appropriateness for different age groups (`T` for Teen or `A` for Adults). It helps in filtering content for players.
