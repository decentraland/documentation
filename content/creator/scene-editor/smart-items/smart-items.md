...
By default, all items share their updates on only the components that are relevant to their normal behavior. You can change this in the [Advanced View]({{< ref "/content/creator/scene-editor/smart-items/smart-items-advanced.md" >}}).
