...
The Decentraland Editor allows you to compile and preview your scene locally. After testing your scene locally, you can use the editor to upload your content to Decentraland.

Read [Installation guide]({{< ref "/content/creator/scenes/getting-started/installation-guide.md" >}}) for more details about installing the Editor.
